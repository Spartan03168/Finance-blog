...
class BankSeeder extends Seeder {
    ...
    public function run(): void {
        $bank_data = storage_path("app/public/Banks_DB.csv");
        ...
        foreach ($data_extract as $row){
            ...
            DB::table("banks")->insert([
                ...
                "number_of_branches" => (int) ($row["Number of branches"] ?? 0),
                "countries_with_branches" => (int) ($row["Countries with branches"] ?? 0),
                ]);
            }
